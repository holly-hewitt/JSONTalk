...
public class FunParser extends Parser {
	...
	public static class Switch_exprContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunVisitor ) return ((FunVisitor<? extends T>)visitor).visitSwitch_expr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Switch_exprContext switch_expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(197);
				((Switch_exprContext)_localctx).e1 = prim_expr();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				((Switch_exprContext)_localctx).e1 = prim_expr();
				setState(199);
				((Switch_exprContext)_localctx).op = match(RANGE);
				setState(200);
				((Switch_exprContext)_localctx).e2 = prim_expr();
				}
				break;
			}
		}
	...
	public static final String _serializedATN =
		...
		"\3\2\22\24\3\2\25\30\2\u00de\2\37\3\2\2\2\4N\3\2\2\2\6P\3\2\2\2\bX\3\2"+
		...
		"\2 #\3\2\2\2!\37\3\2\2\2\"$\5\4\3\2#\"\3\2\2\2$%\3\2\2\2%#\3\2\2\2%&\3"+
		"\2\2\2&\'\3\2\2\2\'(\7\2\2\3(\3\3\2\2\2)*\7\t\2\2*+\7\"\2\2+-\7\34\2\2"+
